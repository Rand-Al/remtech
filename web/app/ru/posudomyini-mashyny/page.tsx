...
export const metadata: Metadata = {
  title: "Ремонт посудомоечных машин в Броварах — RemTech",
  description:
    "Ремонт посудомоечных машин в Броварах и Броварском районе с выездом мастера.",
  alternates: {
    canonical: "https://example.com/ru/posudomyini-mashyny/",
    languages: {
  ...
  openGraph: {
    type: "website",
    title: "Ремонт посудомоечных машин в Броварах — RemTech",
    url: "https://example.com/ru/posudomyini-mashyny/",
    description:
      "Ремонт посудомоечных машин в Броварах и Броварском районе с выездом мастера и диагностикой.",
  },
};

export default async function RuPosudomyiniMashynyPage() {
  const contacts = await getContacts();
  const phoneHref = phoneHrefFromPhone(contacts.phone);
  return (
    <>
      <Header variant="service" lang="ru" altLangHref="/posudomyini-mashyny/" />

      <main>
        <section className="hero service-page-hero dishwasher-page-hero">
          <div className="hero-image" role="img" aria-label="Посудомоечная машина в домашнем помещении"></div>
          <div className="hero-content">
            <p className="location">Посудомоечные машины · Бровары и Броварский район</p>
            <h1>Ремонт посудомоечных машин в Броварах и Броварском районе</h1>
            <p className="hero-copy">Посудомоечная машина не моет посуду, не сливает воду, протекает или показывает ошибку? Опишите неисправность — менеджер уточнит детали для мастера.</p>
        ...
        <section className="dishwasher-symptoms" id="symptoms">
          <div className="dishwasher-symptoms-heading">
            <p className="section-kicker">Ремонт посудомоечных машин</p>
            ...
            <button type="button" data-open-chat data-service="dishwasher">Описать неисправность менеджеру</button>
          </div>
          ...
          <ul className="dishwasher-symptom-list">
            ...
            <li><span>03</span><strong>Плохо моет посуду</strong></li>
        ...
        <section className="dishwasher-terms" id="terms">
          ...
          <div className="dishwasher-terms-steps">
            ...
            <article>
              <span>На месте</span>
              <h3>Осмотр машины</h3>
              <p>Мастер осмотрит посудомоечную машину и определит объем нужных работ.</p>
            </article>
            <article>
        ...
        <section className="dishwasher-final-cta" id="contact">
          <div>
            ...
            <h2>Нужна помощь с посудомоечной машиной?</h2>
      ...
      <Footer variant="service" lang="ru" altLangHref="/posudomyini-mashyny/" />
      <ChatPanel defaultService="dishwasher" lang="ru" />
    </>
  );
}
